...
setup( \
    ...
    data_files = [
        (datadir + "pixmaps",
            ["pixmaps/porthole-about.png", "pixmaps/porthole-icon.png",  "pixmaps/porthole-clock.png", "pixmaps/porthole.svg"]),
        (datadir + "help",
        ...
        (datadir,
            ["advancedemerge/advemerge.glade", "porthole.glade", "config/config.glade", "config/configuration.xml",
             "scripts/dopot.sh", "scripts/pocompile.sh", "backends/set_config.py"]),
        (datadir + "i18n",
