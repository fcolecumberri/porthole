...
'''
    ...
    Copyright (C) 2004 - 2007 Brian Bockelman, Tommy Iorns, Brian Dolbec.
...
def enable_plugin():
    ...
    if is_root():
        utils.debug.dprint(plugin_name + " enabling plugin to run_as_user")
        menuitem1.connect("activate", run_as_user)
    else:
        utils.debug.dprint(plugin_name + " enabling plugin to run_as_root")
